...
def set_terrain(length, width, field_resolution, difficulty):
    """Multiple sideways-facing ramps traversing a pit for the robot to climb on and jump across."""
    ...
    platform_width = np.random.uniform(1.0, 1.1)  # Decrease platform width
