...
def get_camera_coords(col_idx, row_idx, cam_height=4.0):
    ...
    all_configs = {
        ...
        ((2,3), 0): ((-17.5, 8.0, cam_height), (1.0, 0.0, 0.15, 0.0)),
        ((0,1), 1): ((-17.5, 8.0, cam_height), (1.0, 0.0, 0.15, 0.0)),
        ((2,3), 1): ((-17.5, 8.0, cam_height), (1.0, 0.0, 0.15, 0.0)),
        ((0,1), 2): ((-17.5, 8.0, cam_height), (1.0, 0.0, 0.15, 0.0)),
        ((2,3), 2): ((-17.5, 8.0, cam_height), (1.0, 0.0, 0.15, 0.0)),
        ((0,1), 3): ((-17.5, 8.0, cam_height), (1.0, 0.0, 0.15, 0.0)),
        ((2,3), 3): ((-17.5, 8.0, cam_height), (1.0, 0.0, 0.15, 0.0)),
    }

    return {
        "position": all_configs[(row_idx, col_idx)][0],
        "rotation": all_configs[(row_idx, col_idx)][1]
    }
